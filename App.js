  ...
  return (
    <NavigationContainer>
      <Stack.Navigator initialRouteName="Login" screenOptions={{ headerShown: false }}>
        ...
        <Stack.Screen name="QuizReciclaje" component={QuizReciclajeScreen} />
        <Stack.Screen name="QuizCambioClimatico" component={QuizCambioClimaticoScreen} />
        <Stack.Screen name="QuizBiodiversidad" component={QuizBiodiversidadScreen} />
